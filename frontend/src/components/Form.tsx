...
import { Box, TextField, Button, Typography, Slider, RadioGroup, FormControlLabel, Radio, Checkbox, FormGroup } from '@mui/material';
...
export default function CustomForm() {
  ...
  return (
    <Box component="form" sx={{ '& .MuiTextField-root': { m: 1, width: '25ch' } }}>
      ...
      <TextField label="Current Fitness Level" select SelectProps={{ native: true }}>
      ...
      <Typography>Can you touch your toes without bending your knees?</Typography>
      <RadioGroup row>
      ...
      <FormGroup>
        ...
        <FormControlLabel control={<Checkbox />} label="I understand that this program is not a substitute for medical advice." />
      </FormGroup>

      <Button variant="contained" type="submit">Create My Personalized Routine</Button>
    </Box>
  );
}
